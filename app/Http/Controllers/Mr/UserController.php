...
class UserController extends Controller
{
    ...
    {
        $users = User::all();
        return view('mr.index')->with(compact('users'));
    }
    ...
    public function removed()
    {
        return 'here';
        $users = User::all();
        return view('mr.removed')->with(compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mr.users.index')->with('success', 'User created successfully!');
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('mr.edit')->with(compact('user'));
    }
