...
class UserController extends Controller
{
    ...
    {
        $users = User::all();
        return view('ms.index')->with(compact('users'));
    }
    ...
    public function removed()
    {
        return 'here';
        $users = User::all();
        return view('ms.removed')->with(compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('ms.users.index')->with('success', 'User created successfully!');
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('ms.edit')->with(compact('user'));
    }
