...
@section('content')
    <div class="card">
        <div class="card-header">
            <a href="{{ route('mr.users.create') }}" class="btn btn-success btn-sm">New User</a>
        </div>
        <div class="card-body">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $user->username }}</td>
                        <td>
                            <a href="{{ route('mr.users.edit',$user->id) }}" class="btn btn-sm btn-info text-white">Edit</a>
                        </td>
                        <td>
                            <form method="POST" action="{{ route('mr.users.destroy',$user->id) }}">
                            @csrf
                            @method('DELETE')
